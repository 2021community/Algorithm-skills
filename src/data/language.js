			...
			skills: [
				{
					name: "C, C++",
					description: {
						text: "C와 C++은 문법이 서로 비슷한 언어이다. 하지만 C++의 편리함 때문에 주력언어로 C보다는 C++을 많이 사용한다.",
						links: [
					...
					skills: [
						{
							name: "C언어",
							description: {
								text: "출력 형식이 비교적 자유로우며, 포인터, 구조체 등을 입문하기에 좋은 언어이다. 하지만 대부분의 자료구조들을 직접 구현해야 되기 때문에 C언어로 입문한 후, C++ 갈아타는 것을 추천한다.",
								links: [
						...
						},
						{
							name: "C++",
							description: {
								text: "초심자가 입문하긴 어렵지만, 상위권의 주력언어로 많이 사용되기 때문에 학습자료가 많다는 장점을 가지고 있다.",
								links: [
				...
				},
				{
					name: "python",
					description: {
						text: "integer overflow를 고려할 필요가 없다는 장점이 있지만, 실행시간이 느리다는 단점이 있다.",
						links: [
				...
				},
				{
					name: "java",
					description: {
						text: "개발쪽에선 범용성이 최강이다. 하지만 코딩 테스트에선 실행시간이 c++보다 느리며, 문법이 어렵다는 단점을 가지고 있다.",
						links: [
				...
				},
				{
					name: "javascript",
					description: {
						text: "웹 프론트엔드 직무 지원 시, 오로지 자바스크립트만 사용 가능한 언어로 지정하는 경우가 있다. 하지만 이 경우가 아니라면 코딩 테스트의 주력언어로는 다른 언어를 고르는 것을 추천한다.",
						links: [
							["자바스크립트 - 위키백과", "https://ko.wikipedia.org/wiki/%EC%9E%90%EB%B0%94%EC%8A%A4%ED%81%AC%EB%A6%BD%ED%8A%B8"],
						]
					}
				},
				{
					name: "swift",
					description: {
						text: "IOS 직무 지원 시, 오로지 Swift만 사용 가능한 경우가 꽤 있다. 하지만 이 경우가 아니라면 코딩 테스트의 주력언어로는 다른 언어를 고르는 것을 추천한다.",
						links: [
