			...
			skills: [
				{
					name: "정렬",
					description: {
						text: "원소들을 번호순이나 사전 순서와 같이 일정한 순서대로 열거하는 알고리즘이다.",
						links: [
					...
					skills: [
						{
							name: "버블 정렬",
							description: {
								text: "두 인접한 원소를 검사하여 정렬하는 방법이다. 시간 복잡도가 O(n²)으로 상당히 느리지만, 코드가 단순하기 때문에 자주 사용된다.",
								links: [
						...
						},
						{
							name: "선택 정렬",
							description: {
								text: "알고리즘이 단순하며 사용할 수 있는 메모리가 제한적인 경우에 사용시 성능 상의 이점이 있다. 하지만 버블 정렬과 마찬가지로 시간복잡도가 O(n²)로 상당히 느리다.",
								links: [
						...
						},
						{
							name: "병합 정렬",
							description: {
								text: "시간복잡도가 O(n log n)인 비교 기반 정렬 알고리즘이다. 일반적인 방법으로 구현했을 때 이 정렬은 안정(stable) 정렬에 속하며, 분할 정복 알고리즘의 하나이다.",
								links: [
						...
						},
						{
							name: "퀵 정렬",
							description: {
								text: "n개의 데이터를 정렬할 때, 최악의 경우에는 O(n²)번의 비교를 수행하고, 평균적으로 O(n log n)번의 비교를 수행한다.",
								links: [
				...
				},
				{
					name: "검색",
					description: {
						text: "이름 그대로 검색 문제를 해결하는 어떠한 알고리즘들을 일컬어 부르는 말이다.",
						links: [
					...
					skills: [
						{
							name: "선형 검색",
							description: {
								text: "리스트에서 찾고자 하는 값을 맨 앞에서부터 끝까지 차례대로 찾아나가는 알고리즘이다.",
								links: [
						...
						},
						{
							name: "이진 검색",
							description: {
								text: "오름차순으로 정렬된 리스트에서 특정한 값의 위치를 찾는 알고리즘이다.",
								links: [
						...
						},
						{
							name: "두 포인터",
							description: {
								text: "정렬된 리스트에서 처음 값 그리고 끝 값을 활용하여 O(N) 만에 원하는 값을 찾아내는 알고리즘이다.",
								links: [
						...
						},
						{
							name: "해싱",
							description: {
								text: "임의의 길이의 데이터를 고정된 길이의 데이터로 매핑하는 함수이다. 이 해싱은 매우 빠른 데이터 검색을 위한 컴퓨터 소프트웨어에 널리 사용된다.",
								links: [
				...
				},
				{
					name: "DP",
					description: {
						text: "복잡한 문제를 간단한 여러 개의 문제로 나누어 푸는 방법을 말한다.",
						links: [
			...
			skills: [
			    {
                    ...
                    description: {
                        ...
                        links: [
                            ...
                            ["문자열 추천문제 - 백준", "https://www.acmicpc.net/problem/1152"],
                        ]
                    },
                    skills: [
                        {
                            ...
                            description: {
                                ...
                                links: [
                                    ...
                                    ["KMP 추천문제 - 백준", "https://www.acmicpc.net/problem/1786"],
                                ]
                            }
                        },
                        {
                            ...
                            description: {
                              ...
                              links: [
                                  ...
                                  ["아호 코라식 추천문제 - 백준", "https://www.acmicpc.net/problem/10256"],
                              ]
                            }
                        },
                        {
                            ...
                            description: {
                                ...
                                links: [
                                    ...
                                    ["트라이 추천문제 - 백준", "https://www.acmicpc.net/problem/14725"],
                                ]
                            }
                        },
                        {
                            ...
                            description: {
                                ...
                                links: [
                                    ...
                                    ["매니커 추천문제 - 백준", "https://www.acmicpc.net/problem/13275"],
                                ]
                            }
                        }
                    ]
			    },
			    {
                    ...
                    description: {
                        ...
                        links: [
                            ...
                            ["백트래킹 추천문제 - 백준", "https://www.acmicpc.net/problem/9663"],
                        ]
                    }
                },
                {
                    ...
                    description: {
                        ...
                        links: [
                            ["코팅테스트에 나오는 수학 정리 - 블로그", "https://data-make.tistory.com/408"],
                            ["정수론 추천문제 - 백준", "https://www.acmicpc.net/problem/2960"],
                        ]
                    }
                },
                {
                    ...
                    description: {
                        ...
                        links: [
                            ["순열, 조합, 부분집합 비교 - 블로그", "https://data-make.tistory.com/493?category=347122"],
                            ["조합론 추천문제 - 백준", "https://www.acmicpc.net/problem/1670"],
                        ]
                    }
                },
                {
                    ...
                    description: {
                        ...
                        links: [
                            ["기하 알고리즘 - 블로그", "https://allinfom.tistory.com/53"],
                            ["기하 추천문제 - 백준", "https://www.acmicpc.net/problem/17386"],
                        ]
                    }
                },
                {
                    ...
                    description: {
                        ...
                        links: [
                            ...
                            ["최단 경로 추천문제 - 백준", "https://www.acmicpc.net/problem/1753"],
                        ]
                    },
                    skills: [
                        {
                            ...
                            description: {
                                ...
                                links: [
                                    ...
                                    ["밸만 포드 추천문제 - 백준", "https://www.acmicpc.net/problem/11657"],
                                ]
                            }
                        },
                        {
                            ...
                            description: {
                                ...
                                links: [
                                    ...
                                    ["플로이드 와셜 추천문제 - 백준", "https://www.acmicpc.net/problem/11404"],
                                ]
                            }
                        }
                    ]
                },
                {
                    ...
                    description: {
                        ...
                        links: [
                            ...
                            ["세그먼트 트리 추천문제 - 백준", "https://www.acmicpc.net/problem/2042"],
                            ["세그먼트 트리의 기초 - 유튜브", "https://www.youtube.com/watch?v=shOg2iWIl50&ab_channel=%EB%AC%B8%EB%8F%99%EA%B5%AD"]
                        ]
                    }
                },
                {
                    ...
                    description: {
                        ...
                        links: [
                            ["네트워크 플로우 - 블로그", "https://blog.naver.com/ndb796/221237111220"],
                            ["네트워크 플로우 추천문제 - 백준", "https://www.acmicpc.net/problem/6086"],
                        ]
                    },
                    skills: [
                        {
                            ...
                            description: {
                                ...
                                links: [
                                    ["이분 매칭 - 블로그", "https://blog.naver.com/PostView.naver?isHttpsRedirect=true&blogId=ndb796&logNo=221240613074"],
                                    ["이분 매칭 추천문제 - 백준", "https://www.acmicpc.net/problem/11375"],
                                ]
                            }
                        }
                    ]
